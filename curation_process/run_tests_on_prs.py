...
def run_tests_on_prs():
    ...
    # To highlight the acetate/leucine/isolecuine fixes use PRs 273-310
    # Going to 311 shows the decrease from adding new data from Franzi
    pull_requests = list(range(273, 311))
