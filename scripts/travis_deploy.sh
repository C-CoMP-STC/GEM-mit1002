...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "hgscott/mit1002-model" ]]; then
...
echo "Your new report will be visible at https://hgscott.github.io/mit1002-model in a moment."
